...
translate indonesian translations_20b9a600:
    ...
    e "Ini mencakup penerjemahan setiap string dalam game, termasuk dialog, pilihan menu, teks antarmuka, serta gambar dan aset lainnya."
...
translate indonesian translations_317d73e5:
    ...
    e "Sebagai contoh, berikut adalah cara kita mendefinisikan karakter dan namanya."
...
translate indonesian translations_ab0f3c94:
    ...
    e "Untuk menandai nama Lucy agar dapat diterjemahkan, kita mengapitnya dengan tanda kurung yang didahului oleh satu garis bawah (underscore)."
...
translate indonesian translations_c81acfc7:
    ...
    e "Perhatikan bahwa kita tidak menerjemahkan kode warna kemerahan yang kita gunakan untuk namanya. Warna tersebut tetap sama untuk semua bahasa."
...
translate indonesian translations_82c9748e:
    ...
    e "Pernyataan 'translate python' dapat digunakan untuk mengatur nilai variabel GUI guna mengubah font."
...
translate indonesian translations_a0042025:
    ...
    e "Pernyataan 'translate style' mengatur properti gaya secara lebih langsung."
...
translate indonesian translations_a91befcc:
    ...
    e "Berikut adalah cuplikan dari layar preferensi tutorial ini. Aksi 'Language' memberi tahu Ren'Py untuk mengubah bahasa. Ia menerima string berisi nama bahasa, atau 'None'."
...
translate indonesian translations_9b7d6401:
    ...
    e "Bahasa 'None' bersifat spesial, karena itu adalah bahasa default saat visual novel tersebut ditulis. Karena tutorial ini ditulis dalam bahasa Inggris, 'Language(None)' akan memilih bahasa Inggris."
