...
translate indonesian screens_demo_1bdfb4bd:
    ...
    e "Dan ketika pernyataan 'menu' menampilkan pilihan di dalam permainan, layar 'choice' akan digunakan. Mengerti?" nointeract
...
translate indonesian screens_demo_31a20e24:
    ...
    e "Input teks menggunakan layar 'input', mode NVL menggunakan layar 'nvl', dan seterusnya."
...
translate indonesian screens_demo_5a5aa2d5:
    ...
    e "Lebih dari satu layar dapat ditampilkan sekaligus. Misalnya, tombol di bagian bawah - Kembali, Riwayat, Lewati, dsb - semuanya ditampilkan oleh layar 'quick_menu' yang muncul sepanjang waktu."
...
translate indonesian screens_demo_a136e191:
    ...
    e "Sebagai contoh, dalam novel visual bergaya RPG, sebuah layar dapat menampilkan statistik pemain."
...
translate indonesian screens_demo_8a54de7a:
    ...
    e "Layar yang kompleks dapat menjadi dasar dari seluruh mekanik game. Layar statistik seperti ini bisa menjadi dasar untuk game simulasi kencan atau simulasi kehidupan."
...
translate indonesian screens_demo_62c184f8:
    ...
    e "Meskipun layar mungkin terlihat rumit, sebenarnya itu hanyalah hasil dari banyak bagian sederhana yang bekerja sama untuk membuat sesuatu yang lebih besar."
...
translate indonesian screens_showing_1b51e9a4:
    ...
    e "Berikut adalah contoh layar yang sangat sederhana. Pernyataan 'screen' digunakan untuk memberi tahu Ren'Py bahwa ini adalah sebuah layar, dan namanya adalah 'simple_screen'." id screens_showing_1b51e9a4
...
translate indonesian screens_showing_5a6bbad0:
    ...
    e "Di dalam pernyataan layar, baris-baris kode memperkenalkan displayable seperti frame, vbox, text, dan textbutton; atau properti seperti action, xalign, dan ypos."
...
translate indonesian screens_showing_bc320819:
    ...
    e "Pernyataan 'text' digunakan untuk menampilkan teks yang diberikan."
...
translate indonesian screens_showing_64f23380:
    ...
    e "Pernyataan 'textbutton' memperkenalkan tombol yang dapat diklik. Saat tombol diklik, 'action' atau aksi yang diberikan akan dijalankan."
...
translate indonesian screens_showing_e8f68c08:
    ...
    e "Keduanya berada di dalam pernyataan 'vbox' (kotak vertikal) - yang menempatkan teks di atas tombol."
...
translate indonesian screens_showing_7e48fc22:
    ...
    e "Dan itu semua berada di dalam sebuah 'frame' (bingkai) yang menyediakan latar belakang dan tepi. Frame tersebut memiliki properti 'at' yang mengambil transformasi untuk menentukan posisinya."
...
translate indonesian screens_showing_80425bf3:
    ...
    e "Ada tiga jenis pernyataan yang digunakan untuk menampilkan layar."
...
translate indonesian screens_showing_7d2deb37:
    ...
    e "Yang pertama adalah pernyataan 'show screen', yang menampilkan layar dan membiarkan Ren'Py terus menjalankan skrip di bawahnya."
...
translate indonesian screens_showing_7626dc8b:
    ...
    e "Layar tersebut akan tetap muncul sampai ia disembunyikan."
...
translate indonesian screens_showing_c79038a4:
    ...
    e "Menyembunyikan layar dilakukan dengan pernyataan 'hide screen'."
...
translate indonesian screens_showing_8f78a97d:
    ...
    e "Pernyataan 'call screen' menghentikan Ren'Py dari menjalankan skrip sampai layar tersebut mengembalikan nilai, atau melompatkan skrip ke tempat lain."
...
translate indonesian screens_showing_c5ca730f:
    ...
    e "Ketika pernyataan 'call screen' berakhir, layar tersebut akan otomatis disembunyikan."
...
translate indonesian screens_parameters_0666043d:
    ...
    e "Berikut adalah contoh layar yang menerima tiga parameter. Parameter 'message' adalah pesan yang ditampilkan, sementara aksi 'okay' dan 'cancel' dijalankan saat tombol yang sesuai ditekan."
...
translate indonesian screens_parameters_cf95b914:
    ...
    e "Meskipun parameter 'message' harus selalu diisi, parameter 'okay' dan 'cancel' memiliki nilai default yang akan digunakan jika tidak ada argumen yang diberikan."
...
translate indonesian screens_parameters_4ce03111:
    ...
    e "Setiap parameter adalah variabel yang didefinisikan di dalam layar. Di dalam layar ini, variabel tersebut memiliki prioritas lebih tinggi dibandingkan variabel yang digunakan di bagian lain Ren'Py."
...
translate indonesian screens_parameters_106c2a04:
    ...
    e "Saat layar ditampilkan, argumen dapat diberikan untuk setiap parameter. Argumen dapat diberikan berdasarkan posisi atau berdasarkan nama."
...
translate indonesian screens_parameters_12ac92d4:
    ...
    e "Parameter memungkinkan kita mengubah apa yang ditampilkan layar, cukup dengan menampilkannya kembali dengan argumen yang berbeda."
...
translate indonesian screens_parameters_d143a994:
    ...
    e "Pernyataan 'call screen' juga dapat menerima argumen, sama seperti 'show screen'."
...
translate indonesian screens_properties_423246a2:
    ...
    e "Ada beberapa properti yang dapat diterapkan pada layar itu sendiri."
...
translate indonesian screens_properties_550c0bea:
    ...
    e "Ketika sebuah layar memiliki properti 'tag', ia diperlakukan seperti bagian tag dari nama gambar. Di sini, saya menampilkan 'a_tag_screen'."
...
translate indonesian screens_properties_4fcf8af8:
    ...
    e "Ketika saya menampilkan 'b_tag_screen', layar tersebut menggantikan 'a_tag_screen'."
...
translate indonesian screens_properties_5d51bd1e:
    ...
    e "Karena alasan tertentu, tag menerima nama, bukan sebuah ekspresi. Sudah terlambat untuk mengubah ketetapan ini."
...
translate indonesian screens_properties_6706e266:
    ...
    e "Properti 'zorder' mengontrol urutan layar saling bertumpang tindih. Semakin besar angka zorder, semakin dekat layar tersebut ke arah pemain."
...
translate indonesian screens_properties_f7a2c73d:
    ...
    e "Secara default, layar memiliki zorder 0. Ketika dua layar memiliki angka zorder yang sama, layar yang ditampilkan belakangan akan berada lebih dekat ke pemain."
...
translate indonesian screens_properties_78433eb8:
    ...
    e "Properti 'variant' memilih layar berdasarkan properti perangkat yang menjalankannya."
...
translate indonesian screens_properties_e6db6d02:
    ...
    e "Dalam contoh ini, layar pertama akan digunakan untuk perangkat kecil seperti ponsel, dan layar lainnya akan digunakan untuk tablet dan komputer."
...
translate indonesian screens_properties_d21b5500:
    ...
    e "Terakhir, properti 'style_prefix' menentukan awalan yang diterapkan pada gaya (style) di dalam layar tersebut."
...
translate indonesian screens_properties_560ca08a:
    ...
    e "Ketika awalan 'red' diberikan, frame akan mendapatkan gaya 'red_frame', dan teks akan mendapatkan gaya 'red_text'."
...
translate indonesian screens_properties_c7ad3a8e:
    ...
    e "Ini dapat menghemat banyak waktu mengetik saat memberikan gaya pada layar yang berisi banyak objek tampilan."
...
translate indonesian screens_control_0e939050:
    ...
    e "Pernyataan 'python' bekerja hampir sama dengan yang ada di skrip. Satu baris Python diperkenalkan dengan tanda dolar ($). Baris ini dijalankan setiap kali layar diperbarui."
...
translate indonesian screens_control_6334650a:
    ...
    e "Demikian pula, pernyataan 'python:' memperkenalkan blok pernyataan python yang menjorok ke dalam. Tetapi ada satu perbedaan besar antara Python di layar dan Python di skrip."
...
translate indonesian screens_control_f75fa254:
    ...
    e "Alasannya adalah karena Ren'Py akan menjalankan layar, termasuk Python di dalamnya, selama proses prediksi layar."
...
translate indonesian screens_control_39e0f7e6:
    ...
    e "Pernyataan 'default' berbeda dari pernyataan Python karena ia hanya dijalankan sekali. Python berjalan setiap kali layar diperbarui, sehingga jika diletakkan di sana, variabel tidak akan pernah berubah nilainya."
...
translate indonesian screens_control_87a75fe7:
    ...
    e "Pernyataan 'if' bekerja seperti di skrip, menjalankan satu blok jika kondisi benar dan blok lain jika kondisi salah."
...
translate indonesian screens_control_6a8c07f6:
    ...
    e "Pernyataan 'for' mengambil daftar nilai dan melakukan iterasi padanya, menjalankan blok di dalam loop dengan variabel yang terikat pada setiap item daftar."
...
translate indonesian screens_control_f7b755fa:
    ...
    e "Pernyataan 'on' dan 'key' mungkin hanya masuk akal jika diletakkan di tingkat teratas layar."
...
translate indonesian screens_control_328b0676:
    ...
    e "Pernyataan 'on' membuat layar menjalankan aksi saat sebuah peristiwa terjadi. Peristiwa 'show' terjadi saat layar pertama kali muncul, dan 'hide' terjadi saat ia disembunyikan."
...
translate indonesian screens_control_6768768b:
    ...
    e "Peristiwa 'key' menjalankan sebuah aksi saat sebuah tombol ditekan."
...
translate indonesian screen_use_95a34d3a:
    ...
    e "Ambil contoh layar ini, yang menampilkan dua entri statistik. Sudah ada banyak duplikasi di sana, dan jika kita punya lebih banyak statistik, duplikasinya akan bertambah."
...
translate indonesian screen_use_e2c673d9:
    ...
    e "Di sini, kita memindahkan pernyataan yang menampilkan teks dan bar ke layar kedua, dan pernyataan 'use' menyertakan layar tersebut ke layar pertama."
...
translate indonesian screen_use_2efdd2ff:
    ...
    e "Nama dan jumlah statistik diteruskan sebagai argumen ke layar, persis seperti yang dilakukan pada pernyataan 'call screen'."
...
translate indonesian screen_use_f8d1bf9d:
    ...
    e "Dengan cara ini, kita mengontrol jumlah duplikasi, dan dapat mengubah tampilan statistik di satu tempat saja."
...
translate indonesian screen_use_4e22c25e:
    ...
    e "Pernyataan 'transclude' selangkah lebih maju, dengan membiarkan pernyataan 'use' mengambil satu blok pernyataan bahasa layar."
...
translate indonesian screen_use_c83b97e3:
    ...
    e "Ketika layar yang disertakan mencapai pernyataan 'transclude', ia digantikan dengan blok kode dari pernyataan 'use'."
...
translate indonesian screen_use_1ad1f358:
    ...
    e "Layar 'boilerplate' disertakan dalam layar pertama, dan teks dari layar pertama ditransklusikan ke dalam layar 'boilerplate'."
...
translate indonesian strings:
    ...
    new "Apa yang bisa dilakukan layar."

    # game/tutorial_screens.rpy:171
    old "How to show screens."
    new "Cara menampilkan layar."

    # game/tutorial_screens.rpy:171
    old "Passing parameters to screens."
    new "Meneruskan parameter ke layar."
    ...
    new "Pernyataan layar khusus."

    # game/tutorial_screens.rpy:171
    old "Using other screens."
    new "Menggunakan layar lain."
    ...
    old "Shiro was here."
    new "Shiro pernah di sini."

    # game/tutorial_screens.rpy:362
    old "Click either button to continue."
    new "Klik tombol mana saja untuk melanjutkan."
    ...
    new "Tidak banyak lagi yang bisa dilihat."
